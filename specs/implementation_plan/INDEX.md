...
- **Arms:** n8n Workers — Specialized sub-workflows for image processing, Meta publishing, and centralized logging, orchestrated via Upstash Redis queues. **Strategic Scheduling** delays post publication until peak engagement hours.

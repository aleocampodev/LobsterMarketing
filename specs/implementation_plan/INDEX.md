...
**2026-05-05:** Adopted **Supervisor Pattern** (v2.2): Modular architecture with a main Supervisor workflow delegating to specialized sub-workflows (Brand, Content, Approval).

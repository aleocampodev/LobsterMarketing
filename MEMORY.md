...
## Session Log
- **2026-05-07:** Fixed media flow (architecture v2.6). New files in Drive are auto-processed by Oracle (resize, watermark) without Telegram notification. Heartbeat only notifies Shirley at 9am if pipeline is empty. Watermark logo stored in Supabase Storage bucket `nenufar-assets`. Updated: architecture.md v2.6, media_processor_api.md, data_architecture.md v1.7, AGENTS.md.
